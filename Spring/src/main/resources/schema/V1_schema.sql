...
-- 사용자 테이블
CREATE TABLE USERS (
    USER_ID NUMBER(20) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
-- 역할 테이블
CREATE TABLE ROLE (
    ROLE_ID NUMBER(20) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
